...
export const newAdditionsChecklists: ChecklistSpec[] = [
  ...
  { slug: "rn-acute-rehab", title: "Registered Nurse – Acute Rehab Skills Checklist", shortTitle: "RN – Acute Rehab", icon: "🦽", group: "Specialty Care", categories: [
    { title: "Neurological Rehabilitation", skills: [
      { name: "Level of consciousness" }, { name: "Pupil size/shape/reaction" }, { name: "Sensory function" }, { name: "Berg balance score" }, { name: "Facial symmetry" }, { name: "Mini mental status exam (MMSE)" }, { name: "Swallow screen" }, { name: "Bowel/bladder function" }, { name: "Language ability" }, { name: "Speech" }, { name: "Muscle strength and coordination" }, { name: "NIH score" }, { name: "Motor function" }, { name: "Glascow coma scale (GCS)" }, { name: "Gait assessment" }, { name: "Manual/Automatic blood pressure" }, { name: "Spinal cord injury" }, { name: "Brain tumors" }, { name: "Cerebral palsy (CP)" }, { name: "Neuromuscular disease" }, { name: "Post craniotomy" }, { name: "Cerebral vascular accident (CVA)" }, { name: "Multiple sclerosis (MS)" }, { name: "Parkinson's disease" }, { name: "Autonomic dysreflexia" }, { name: "Traumatic brain injury (TBI)" }, { name: "Head trauma" }, { name: "Guillain Barre syndrome (GBS)" }, { name: "Communication disorders (e.g., dysarthria, apraxia, aphasia)" }, { name: "Amyotrophic lateral sclerosis (ALS)" }, { name: "Swallow screen" }, { name: "Assist with physical therapy" }, { name: "Assist with ambulation" }, { name: "Airway management devices/suctioning" }, { name: "Communication assistive tools (e.g., white boards, voice output communication aids)" }, { name: "Bladder scan" }, { name: "Vital signs (e.g., BP, HR, O2 sat)" }, { name: "Care of patient on ventilator" },
    ]},
