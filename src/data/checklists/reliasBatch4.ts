...
// Fourth batch of checklists authored from Relias self-assessment content.
export const reliasBatch4Checklists: ChecklistSpec[] = [
  { slug: "cna-hospice-palliative-care", title: "CNA Hospice/Palliative Care Skills Checklist", shortTitle: "CNA Hospice", icon: "🕊️", group: "Nursing", categories: [
    { title: "Personal Care & ADLs", skills: [
    ...
    { title: "Ethics & Patient Rights", skills: [
      { name: "Applying Ethical Principles (Autonomy, Do No Harm)" }, { name: "Recognizing and Escalating Ethical Dilemmas" }, { name: "Upholding Patient Rights and Confidentiality" }, { name: "Interdisciplinary Advocacy" },
    ]},
    { title: "Professional Practice & Documentation", skills: [
      { name: "Factual, Timely Documentation" }, { name: "Personal Safety in Home Care Visits" }, { name: "De-Escalation and PPE Use" }, { name: "Serving as a Preceptor/Mentor" }, { name: "Continuing Education and Self-Care" },
    ]},
    { title: "End of Life & Bereavement", skills: [
      { name: "Postmortem Care and Dignity" }, { name: "Guiding Family Final Goodbyes" }, { name: "Cultural and Religious Ritual Support" }, { name: "Referring Families for Bereavement Support" }, { name: "Grief Support and Self-Care for Caregiver" },
    ]},
  ]},
  ...
  { slug: "cna-snf-ltc", title: "CNA Skilled Nursing / Long-Term Care Skills Checklist", shortTitle: "CNA SNF/LTC", icon: "🏡", group: "Nursing", categories: [
    { title: "Personal Care & ADLs", skills: [
      { name: "Bathing and Skin Care" }, { name: "Oral, Nail, and Foot Care" }, { name: "Shaving (Electric and Disposable Razor)" }, { name: "Dressing and Undressing (Weak/Affected Side Technique)" }, { name: "Toileting and Bladder/Bowel Programs" }, { name: "Catheter and Colostomy Care" }, { name: "Perineal and Incontinence Care" },
    ]},
    { title: "Mobility & Positioning", skills: [
      { name: "Safe Transfer Techniques (Gait Belt, Slide Board, Lift Sheet)" }, { name: "Mechanical Lift Operation (Hoyer, Sit-to-Stand)" }, { name: "Range of Motion Assistance" }, { name: "Assistive Device Use (Walker, Cane, Wheelchair)" }, { name: "Fall Prevention and Restraint Reduction" }, { name: "Prosthetic and Orthotic Device Use" },
    ]},
